...
const Home: NextPage = () => {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-black">
      ...
      <footer className="flex z-30 h-10 w-full items-center justify-center border-t bg-slate-300">
        <a
          className="flex items-center text-sm justify-center gap-2 text-slate-800"
